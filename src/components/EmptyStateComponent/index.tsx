            ...
            <View style={styles.emptyStateForeground}>
                <View style={[styles.emptyStateContent, cardStyles]}>
                    ...
                    <View style={[shouldUseNarrowLayout ? styles.p5 : styles.p8, cardContentStyles]}>
                        ...
                        {children}
                        {!isEmpty(buttons) && (
                            <View style={[styles.gap2, styles.mt5, !shouldUseNarrowLayout ? styles.flexRow : styles.flexColumn, styles.justifyContentCenter, buttons?.length === 1 && styles.alignItemsCenter]}>
