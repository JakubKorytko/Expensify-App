...
function clearReportActionErrors(originalReportID: string | undefined, reportAction: ReportAction, keys?: string[]) {
...
function clearAllRelatedReportActionErrors(
    ...
    clearReportActionErrors(originalReportID, reportAction, keys);
